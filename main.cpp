...
void screen1()
{
    ...
    char str1[]="A  PROJECT  ON";
    drawstring(str1,-0.5,0.9,0.5);
    glColor3f(0.8,0.8,0.8);
    char str2[]="-*-   VERTICAL  LIFT  BRIDGE  SIMULATION   -*-";
    drawstring(str2,-0.65,0.6,0.0);
    glColor3f(0.8,0.8,0.8);
    char str3[]="BY  :";
    drawstring(str3,-0.5,0.5,0.0);
    glColor3f(1.0,1.0,0.0);
    char str4[]="YASHU MITTAL     (20BCS139)";
    drawstring(str4,-0.5,0.4,0.0);
    glColor3f(1.0,0.9,1.0);
    char str5[]="INSTRUCTIONS ";
    drawstring(str5,-0.3,-0.1,0.0);
    char str6[]="----------------";
    drawstring(str6,-0.35,-0.2,0.0);
    char str7[]="* * *   PRESS     -ENTER -     TO  START  AND     -ESC-     TO EXIT   * * *";
    drawstring(str7,-0.9,-0.3,0.0);
    char str8[]="PRESS     -S-     TO  START  ANIMATION   AND  PRESS    -T-     TO  STOP  ANIMATION";
    drawstring(str8,-1.05,-0.45,0.0);
    glFlush();
}
